...
PPSSPP_CONTROL_INI_RG="${PPSSPP_DIR}/MUOS/emulator/ppsspp/rg/.config/ppsspp/PSP/SYSTEM/controls.ini"
PPSSPP_SYSTEM_INI_RG="${PPSSPP_DIR}/MUOS/emulator/ppsspp/rg/.config/ppsspp/PSP/SYSTEM/ppsspp.ini"
PPSSPP_CONTROL_INI_TUI="${PPSSPP_DIR}/MUOS/emulator/ppsspp/tui/.config/ppsspp/PSP/SYSTEM/controls.ini"
PPSSPP_SYSTEM_INI_TUI="${PPSSPP_DIR}/MUOS/emulator/ppsspp/tui/.config/ppsspp/PSP/SYSTEM/ppsspp.ini"
