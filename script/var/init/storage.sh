...
STORAGE_LOCS="bios init info/catalogue info/name retroarch info/config info/controller info/core info/favourite info/history music save screenshot theme language network syncthing package/catalogue package/config"
