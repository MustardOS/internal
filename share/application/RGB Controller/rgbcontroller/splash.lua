...
function splashlib.new(init)
    ...
    -- Load the logo
    self.logo = {
        sprite = love.graphics.newImage("assets/sprites/muos.png"),
    ...
    timer.script(function(wait)
        ...
        timer.tween(0.3, self.logo, {scale = 0.25, alpha = 1}, "out-back")
        wait (0.1)
...
function splashlib:draw()
   ...
   -- Set font for the main title
    ...
    love.graphics.setColor(1, 1, 1, self.logo.alpha)
    love.graphics.printf("RGB Controller", 0, logoBottomY + 20, width, "center")
